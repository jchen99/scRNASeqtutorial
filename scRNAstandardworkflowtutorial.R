...
setwd("L:/Lab-Wiestner/Jonathan/scDNA Sequencing/Tutorials")
...
#look at modalities - Gene Expression, Antibody Capture, and Mutiplexing capture
str(nsclc.sparse.m)
#Count Matrix - gene expression
...
nsclc.seurat.obj
# 31117 features across 58986 samples
...
# computation time
# nsclc.seurat.obj <- JackStraw(nsclc.seurat.obj, num.replicate = 100)
